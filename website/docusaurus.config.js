...
const config = {
  title: 'Nextron',
  tagline: '⚡ NEXT.js + Electron ⚡',
  url: 'https://nextron.com',
  baseUrl: '/',
  onBrokenLinks: 'throw',
  ...
  organizationName: 'saltyshiomix', // Usually your GitHub org/user name.
  projectName: 'nextron', // Usually your repo name.
